...
<PageMeta
	title="nostrfy-Dokumentation und Handbuch"
	description="Das komplette nostrfy-Handbuch: Installation, Konfiguration, NIP-Unterstützung, REST-API, Bereitstellungsanleitungen und Fehlerbehebung für die All-in-One-Nostr-Relay-Server-Engine."
/>

<div class="mx-auto max-w-3xl pb-20 pt-12">
	<h1 class="text-3xl font-bold tracking-tight sm:text-4xl">Dokumentation</h1>
	<p class="mt-3 max-w-2xl text-base text-zinc-400">
		Alles, was Sie zum Installieren, Konfigurieren, Betreiben und Skalieren eines nostrfy-Relays brauchen — mit vollständiger Funktionsreferenz und einer Fehlerbehebung, die am tatsächlichen Verhalten des Relays gepflegt wird.
	</p>
	...
	<div class="mt-12 rounded-xl border border-line bg-surface/40 p-5 text-sm text-zinc-400">
		...
		<a href={site.github} target="_blank" rel="noopener noreferrer" class="text-accent-300 hover:underline">
			GitHub</a
		>
		 ein Issue mit Reproduktionsschritten und Log eröffnen — die Dokumentation wird am tatsächlichen Relay-Verhalten gepflegt, Korrekturen sind willkommen.
	</div>
</div>
