<script lang="ts">
	let {
		...
		class: className = '',
		strokeWidth = 1.8
	}: { name?: string; size?: number; class?: string; strokeWidth?: number } = $props();
	...
	const icons: Record<string, string> = {
		...
		network:
			'<rect width="6" height="6" x="16" y="16" rx="1"/><rect width="6" height="6" x="2" y="16" rx="1"/><rect width="6" height="6" x="9" y="2" rx="1"/><path d="M5 16v-3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3"/><path d="M12 12V8"/>',
	...
	const inner = $derived(icons[name] ?? icons['arrow-right']);
</script>
