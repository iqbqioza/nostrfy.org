...
<PageMeta
	title="Documentación y manual de nostrfy"
	description="El manual completo de nostrfy: instalación, configuración, compatibilidad con NIP, API REST, guías de despliegue y solución de problemas para el motor de relé Nostr todo en uno."
/>

<div class="mx-auto max-w-3xl pb-20 pt-12">
	<h1 class="text-3xl font-bold tracking-tight sm:text-4xl">Documentación</h1>
	<p class="mt-3 max-w-2xl text-base text-zinc-400">
		Todo lo necesario para instalar, configurar, ejecutar y escalar un relé nostrfy — con la referencia completa de funciones y una guía de solución de problemas mantenida según el comportamiento real del relé.
	</p>
	...
	<div class="mt-12 rounded-xl border border-line bg-surface/40 p-5 text-sm text-zinc-400">
		¿Necesitas ayuda? Abre un issue en
		<a href={site.github} target="_blank" rel="noopener noreferrer" class="text-accent-300 hover:underline">
			GitHub</a
		>
		con los pasos de reproducción y el registro — la documentación se mantiene según el comportamiento real del relé y las correcciones son bienvenidas.
	</div>
</div>
